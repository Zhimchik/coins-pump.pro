...
use Exceptions\ApiDDosException;
use Exceptions\ApiDisabledException;
 ...
 */
class YobitPublicApiController extends Controller
{
     ...
     * @throws ApiDisabledException|ApiDDosException
     */
    public function getTickers(string $pairs)
    {
//        $query = $this->prepareQueryForPairs($pairs);

        return $this->sendResponse('ticker/' . $pairs);
    }
